...
2. The *steam_games* dataset:

First of all, I like Steam and this dataset looks fun. And as I mentioned above I'm interested by the class of this dataset `spec_tbl_df`, as we didn't seem to cover this in class. Even though the information in many columns looks kind of messy and hard to deal with, I would still want to study the relationship between the reviews, achievements and the price difference of the games. 
