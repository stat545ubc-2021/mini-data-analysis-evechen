...
- The best bin size I choose is `20`. And I think any sizes as `15` or `25` would also look similarly well if we want to take a closer look of the distributions. (Here I only plotted 2 other extreme bin choices for comparisons). 
