...
- I believe I am quite close in answering all of the questions. The first question on whether there are trends in terms of increase of maximum flow still seems unclear at this point. It may be useful to split the years up into further periods and to assess for variability in the data as well as looking further at the range of maximum and minimum flow rates. In addition, it may be useful to refine the yearly data further by splitting the data up with the observations given of “icy conditions”, to see if this may have affected the extremum flow rate on the day of the recording, and to see if there are any trends between icy conditions compared to other conditions.

The data in terms of summarized variables seasonality and periods has provided interested results. It appears that in the 2000s, there is more variability in terms of minimum and maximum rate to a larger range. For seasonality, it appears maximum flow rate is almost exclusively recored during summer months, whereas the majority of minimum flow rate happens in the spring and some in the winter.
- 
- 
- 
